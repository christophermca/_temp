...
function starkers_comment( $comment, $args, $depth ) {
	...
	<article <?php comment_class(); ?> id="comment-<?php comment_ID() ?>">
		...
		<div class="holder_username">
				<div class="avatar"><?php echo get_avatar( $comment, 40 ); ?></div>
					<div class="_username"><?php printf( __( '%s says:', 'starkers' ), sprintf( '%s', get_comment_author_link() ) ); ?></div>
	...
	<div class="clear"></div>
		...
		<div class="dateTimeEdit"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
			<?php
