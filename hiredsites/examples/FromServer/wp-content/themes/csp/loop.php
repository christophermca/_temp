...
<?php /* How to display posts of the Aside format. The asides category is the old way. */ ?>
    ...
    <?php elseif ( ( function_exists( 'get_post_format' ) && 'aside' == get_post_format( $post->ID ) ) || in_category( _x( 'asides', 'asides category slug', 'starkers','book' ) )  ) : ?>
     
        <article id="post-<?php the_ID(); ?>" <?php post_class('widget_book'); ?>>
        ...
        <?php endif; ?>
            ...
            <footer>
                <?php starkers_posted_on(); ?> | <?php comments_popup_link( __( 'Leave a comment', 'starkers' ), __( '1 Comment', 'starkers' ), __( '% Comments', 'starkers' ),__('comment_link') ); ?> <?php edit_post_link( __( 'Edit', 'starkers' ), '| ', '' ); ?>
            </footer>
        </article>
...
<?php /* How to display all other posts. */ ?>
    ...
    <?php else : ?>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<header class="title_meta">
                <strong ><a class="ftsize11 title" href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'starkers' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a>
 <br/>
               <span class=" title ftsize9"> <?php starkers_posted_on();?></span>
               </strong>
            </header>
 
    <?php if ( is_archive() || is_search() ) : // Only display excerpts for archives and search. ?>
                <span style="margin-bottom:15px;"><?php the_excerpt(); ?><a href="<?php echo get_permalink(); ?>"><span style="font-size:9pt;">Read More…</span></a>
                <br/><br/>
</span>
    <?php else : ?>
                <?php the_content( __(  ) ); ?>
 ...
 <div class="comment_links">
            ...
            <?php comments_template( 'starkers', true ); ?>
